...
author: 
    - "Angela C. Bliss, blissan@oregonstate.edu"
...
# Methods
ur analysis will be pretty simple.
...
# set cache = TRUE prevents RMarkddown from regenerating the plot everytime the file is knit
...
kable(tidy(mod), digits = 2, caption = cap_themodel) # use kable package for making tables that will be printed/in pub
```
